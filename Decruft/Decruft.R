...
# source_url("https://raw.github.com/shaptonstahl/R/Decruft/Decruft.R")
#
# or download to keep it local and handy.

cat("Decruft by Stephen Haptonstahl (srh@haptonstahl.org)\n\n")
